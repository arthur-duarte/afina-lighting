...
export const FIXTURE_LIBRARY: FixtureDefinition[] = [
  ...
  },
  {
    type: 'tripod',
    category: 'rigging',
    label: 'Tripé de Iluminação',
    icon: '⟁',
    defaultWattage: 0,
    defaultDmxFootprint: 0,
    defaultLayerId: 'layer_rigging',
    description: 'Tripé telescópico para pedestal de refletores',
    colorHex: '#94a3b8',
  },
  {
    type: 'tower',
    category: 'rigging',
    label: 'Torre de Luz Lateral',
    icon: '🗼',
    defaultWattage: 0,
    defaultDmxFootprint: 0,
    defaultLayerId: 'layer_rigging',
    description: 'Torre / Boom de Iluminação Lateral (Lança)',
    colorHex: '#64748b',
  },
  {
    type: 'floor_base',
    category: 'rigging',
    label: 'Pé de Galinha (Chão)',
    icon: '🪑',
    defaultWattage: 0,
    defaultDmxFootprint: 0,
    defaultLayerId: 'layer_rigging',
    description: 'Pé de Galinha / Suporte baixo para refletores no piso/contra',
    colorHex: '#cbd5e1',
  },
  // ── CENOGRAFIA & ARQUITETURA ─────────────────────────────────
  {
    ...
    description: 'Forma Retangular para representar elementos de cenário',
    colorHex: '#475569',
  },
  {
    type: 'scenery_circle',
    ...
    defaultDmxFootprint: 0,
    defaultLayerId: 'layer_architecture',
    description: 'Forma Circular para representar objetos e cenários',
    colorHex: '#475569',
  },
  {
    ...
    defaultDmxFootprint: 0,
    defaultLayerId: 'layer_architecture',
    description: 'Praticável cênico (2m x 1m)',
    colorHex: '#78350f',
  },
  {
    ...
    defaultDmxFootprint: 0,
    defaultLayerId: 'layer_architecture',
    description: 'Cortina, Perneta ou Rotunda de Fundo',
    colorHex: '#334155',
  },
  {
    type: 'custom_stage',
    category: 'architecture',
    label: 'Palco Personalizado',
    icon: '⎍',
    defaultWattage: 0,
    defaultDmxFootprint: 0,
    defaultLayerId: 'layer_architecture',
    description: 'Palco com dimensões personalizadas e Varanda/Proscênio',
    colorHex: '#38bdf8',
  },
];
